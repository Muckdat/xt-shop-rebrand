                    ...
                    {if $category->hasChildren()}
                        {block name='snippets-categories-mega-category-child'}
                            ...
                            || (isset($activeParent)
                                ...
                                {/link}
                                <div id="category-dropdown-{$category->getID()}" class="dropdown-menu xt-mega-dropdown">
                                    <div class="dropdown-body">
                                        {container class="subcategory-wrapper"}
                                            <div class="xt-mega-inner">
                                                {row class="lg-row-lg nav xt-mega-categories"}
                                                    ...
                                                    {/block}
                                                {/row}
                                                {* Featured Image Card – desktop only *}
                                                <div class="xt-mega-featured d-none d-lg-block">
                                                    <a href="https://www.xt-trade.com/Sicherheitsschuhe" class="xt-mega-featured-link">
                                                        <img src="https://images.unsplash.com/photo-1586281380117-5a60ae2050cc?w=400&h=500&fit=crop&q=80"
                                                             alt="Sicherheitsschuhe Ultralight"
                                                             class="xt-mega-featured-img"
                                                             loading="lazy">
                                                        <div class="xt-mega-featured-overlay">
                                                            <span class="xt-mega-featured-badge">HIGHLIGHT</span>
                                                            <h4 class="xt-mega-featured-title">ULTRALIGHT SERIES</h4>
                                                            <p class="xt-mega-featured-subtitle">Leichter war Sicherheit noch nie.</p>
                                                            <span class="xt-mega-featured-cta">Jetzt entdecken &rarr;</span>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
